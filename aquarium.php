...
<body>
    ...
    <div class="boxed_wrapper">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-2 col-md-6 col-sm-12 single-column">
                                    <div class="single-item tab-btn" data-tab="#tab-1">
                                        <div class="icon-box"><img src="assets/images/icons/aquarium/001-pike.png" alt=""></div>
                                        <h5>Pike fish</h5>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-sm-12 single-column">
                                    <div class="single-item tab-btn active-btn" data-tab="#tab-2">
                                        <div class="icon-box"><img src="assets/images/icons/aquarium/002-marlin.png" alt=""></i></div>
                                        <h5>Marlin fish</h5>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-sm-12 single-column">
                                    <div class="single-item tab-btn" data-tab="#tab-3">
                                        <div class="icon-box"><img src="assets/images/icons/aquarium/003-seahorse.png" alt=""></div>
                                        <h5>Sea horse</h5>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-sm-12 single-column">
                                    <div class="single-item tab-btn" data-tab="#tab-4">
                                        <div class="icon-box"><img src="assets/images/icons/aquarium/004-sea.png" alt=""></div>
                                        <h5>Threadfin</h5>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-sm-12 single-column">
                                    <div class="single-item tab-btn" data-tab="#tab-5">
                                        <div class="icon-box"><img src="assets/images/icons/aquarium/005-clown-fish.png" alt=""></div>
                                        <h5>Clown Fish</h5>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-sm-12 single-column">
                                    <div class="single-item tab-btn" data-tab="#tab-6">
                                        <div class="icon-box"><img src="assets/images/icons/aquarium/006-sea-1.png" alt=""></div>
                                        <h5>Angler Fish</h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="inner-box">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/gallery/aquarium/pike-fish.jpg" alt=""></figure>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab active-tab" id="tab-2">
                            <div class="inner-box">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/gallery/aquarium/Marlin fish.jpeg" alt=""></figure>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab" id="tab-3">
                            <div class="inner-box">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/gallery/aquarium/seahorse.jpg" alt=""></figure>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab" id="tab-4">
                            <div class="inner-box">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/gallery/aquarium/THREADFIN.jpg" alt=""></figure>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab" id="tab-5">
                            <div class="inner-box">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/gallery/aquarium/CLOWN FISH.jpeg" alt=""></figure>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab" id="tab-6">
                            <div class="inner-box">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/gallery/aquarium/ANGLER FISH.jpeg" alt=""></figure>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="video-section centred">
            <div class="img-wrap parallax-demo-1">
                <div class="parallax-inner back-img" style="background-image: url(assets/images/gallery/aquarium/close-up-on-green-fresh-water-aquarium-e1628655395582.jpg);"></div>
            </div>
            <div class="auto-container">
                <div class="inner-box">
                    <div class="video-btn">
                        <a href="https://youtu.be/0j-bWuG5utM?si=0uEQBqkdI1km_UOS" class="lightbox-image" data-caption=""><i class="fas fa-play"></i></a>
                    </div>
                    <h2>ready to Enjoy<br />Underwater aquarium</h2>
                </div>
            </div>
        </section><br><br>
        <!-- video-section end -->
