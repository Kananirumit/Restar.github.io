                    ...
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            ...
                            <div class="text p-3 text-center">
		    						...
		    						<p><span class="price mr-2">₹4500</span> <span class="per">per night</span></p>
		    						<ul class="list">
                    ...
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            ...
                            <div class="text p-3 text-center">
		    						...
		    						<p><span class="price mr-2">₹10000</span> <span class="per">per night</span></p>
		    						<ul class="list">
		    							<li><span>Max:</span> 3 Persons</li>
		    							<li><span>Size:</span> 45 m2</li>
		    							<li><span>View:</span> Sea View</li>
                    ...
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            ...
                            <div class="text p-3 text-center">
		    						...
		    						<p><span class="price mr-2">₹18000</span> <span class="per">per night</span></p>
		    						<ul class="list">
                    ...
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            ...
                            <div class="text p-3 text-center">
		    						...
		    						<p><span class="price mr-2">₹13000</span> <span class="per">per night</span></p>
		    						<ul class="list">
		    							<li><span>Max:</span> 5 Persons</li>
		    							<li><span>Size:</span> 45 m2</li>
		    							<li><span>View:</span> Sea View</li>
                    ...
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            ...
                            <div class="text p-3 text-center">
		    						...
		    						<p><span class="price mr-2">₹22000</span> <span class="per">per night</span></p>
		    						<ul class="list">
                    ...
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            <div class="text p-3 text-center">
		    						...
		    						<p><span class="price mr-2">₹30000</span> <span class="per">per night</span></p>
		    						<ul class="list">
		    							<li><span>Max:</span> 5 Persons</li>
		    							<li><span>Size:</span> 45 m2</li>
		    							<li><span>View:</span> Sea View</li>
...
<!--room section end-->
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div class="content_block_three">
                                <div class="content-box">
                                    <div class="text">
                                        <p>Experience some of the greatest culinary delights at our refreshment stalls and restaurants.The Restar amusment park has three restaurants and numerous refreshment stalls within the park.
        ...
        <section class="video-section centred">
            <div class="img-wrap parallax-demo-1">
                <div class="parallax-inner back-img" style="background-image: url(assets/images/gallery/resort/image_6.jpg);"></div>
            </div>
            <div class="auto-container">
                <div class="inner-box">
                    <div class="video-btn">
                        <a href="https://youtu.be/QhWW0OrFkoQ?si=8cM2h7OlURZHzLSk" class="lightbox-image" data-caption=""><i class="fas fa-play"></i></a>
                    </div>
